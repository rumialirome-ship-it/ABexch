...
const BetInfoPanel: React.FC = () => {
  return (
    <div className="absolute top-0 right-0 bg-background-primary/50 p-4 rounded-lg border border-border-color shadow-glow-inset-accent w-64 hidden lg:block animate-fade-in">
      <div className="mb-4">
        <h3 className="text-accent-secondary font-semibold text-sm uppercase tracking-wider mb-2">Bet Limits</h3>
      ...
      <div>
        <h3 className="text-accent-secondary font-semibold text-sm uppercase tracking-wider mb-2">Prize Rates</h3>
        <ul className="text-xs space-y-1">
          <li className="flex justify-between items-center">
            <span className="text-text-secondary">2-Digit:</span>
