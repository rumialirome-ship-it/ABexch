  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 p-4 animate-fade-in-up">
      <div className="container mx-auto max-w-4xl">
        <div className="bg-background-secondary/90 backdrop-blur-lg rounded-xl shadow-glow-hard shadow-glow-inset-accent border border-border-highlight p-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 md:gap-6">
            <div className="text-center">
              <span className="block text-2xl md:text-3xl font-bold text-accent-primary text-shadow-glow-primary">{betCount}</span>
            ...
            <div className="text-left">
              ...
              <span className="block text-xl md:text-2xl font-bold text-accent-primary font-mono text-shadow-glow-primary">{formatCurrency(totalStake)}</span>
            </div>
          </div>
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <button
              ...
              className="bg-accent-primary text-black font-bold py-2 px-4 md:px-6 rounded-lg transition-all duration-300 hover:opacity-90 hover:-translate-y-0.5 hover:shadow-glow-accent active:scale-95 focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-offset-2 focus:ring-offset-background-secondary disabled:bg-border-color disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0"
            >
              Review & Place
            </button>
          </div>
