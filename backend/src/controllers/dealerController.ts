...
export const handleGetManagedUsers = async (req: AuthenticatedRequest, res: Response) => {
...
export const handleAddUser = async (req: AuthenticatedRequest, res: Response) => {
    const dealerId = req.user?.id;
    if (!dealerId) throw new ApiError(401, 'Dealer not authenticated.');
...
export const handleGetManagedUserById = async (req: AuthenticatedRequest, res: Response) => {
    const dealerId = req.user?.id;
...
export const handleAddCreditToUser = async (req: AuthenticatedRequest, res: Response) => {
    const dealerId = req.user?.id;
    const { userId } = req.params;
...
export const handleUpdateUserBetLimit = async (req: AuthenticatedRequest, res: Response) => {
    const dealerId = req.user?.id;
    const { userId } = req.params;
...
export const handleGetBetsByDealer = async (req: AuthenticatedRequest, res: Response) => {
    const dealerId = req.user?.id;
    if (!dealerId) throw new ApiError(401, 'Dealer not authenticated.');
...
export const handleRequestTopUp = async (req: AuthenticatedRequest, res: Response) => {
    const dealerId = req.user?.id;
