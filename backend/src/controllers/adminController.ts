...
export const handleGetDealerById = async (req: express.Request, res: express.Response) => {
    const { dealerId } = req.params;
    const dealer = await adminService.getDealerById(dealerId);
    res.status(200).json(dealer);
};

export const handleGetUsersForDealer = async (req: express.Request, res: express.Response) => {
    const { dealerId } = req.params;
    const users = await adminService.getUsersForDealer(dealerId);
    res.status(200).json(users);
};

export const handleUpdateUser = async (req: express.Request, res: express.Response) => {
    const { userId } = req.params;
...
export const handleUpdateDealer = async (req: express.Request, res: express.Response) => {
    const { dealerId } = req.params;
    const updatedDealer = await adminService.updateDealer(dealerId, req.body);
    res.status(200).json(updatedDealer);
};

export const handleDeleteDealer = async (req: express.Request, res: express.Response) => {
    const { dealerId } = req.params;
...
export const handleGetDashboardStats = async (req: express.Request, res: express.Response) => {
